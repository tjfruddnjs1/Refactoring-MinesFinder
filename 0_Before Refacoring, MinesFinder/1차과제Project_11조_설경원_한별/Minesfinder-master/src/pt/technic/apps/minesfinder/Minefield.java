...
public class Minefield {
    ...
    public void revealGrid(int x, int y) {
        ...
        else if (states[x][y] == COVERED && GameWindow.isShow==1) {
...
//    public void reviewPlaceMines (int X, int Y) {
//    	for (int i=0;i<X;i++) {
//    		for (int j=0;j<Y;j++) {
//    			mines[i][j]=false;
//    		}
//    	}
//    	for (int i =0;i<GameWindow.numOfMines;i++) {
//    		mines[GameWindow.recMineX.get(i)][GameWindow.recMineY.get(i)]=true;
//    	}
//    }
