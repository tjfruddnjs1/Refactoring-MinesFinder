...
public class Review extends javax.swing.JFrame {
    ...
    private ArrayList<Integer> reviewMapClickedX = new ArrayList<>();
    private ArrayList<Integer> reviewMapClickedY = new ArrayList<>();
    private int reviewMapSizeX;
    private int reviewMapSizeY;
    ...
    public void reviewMapdelete() {
    	recNum--;
    	reviewMapClickedX.remove(recNum);
    	reviewMapClickedY.remove(recNum);
    }
