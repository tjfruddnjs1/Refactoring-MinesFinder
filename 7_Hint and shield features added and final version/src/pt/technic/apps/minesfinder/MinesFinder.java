...
public class MinesFinder extends javax.swing.JFrame {
    ...
    public void btnMultiActionPerformed(java.awt.event.ActionEvent evt) {   	
    	multigameWindow = new GW_2playerMode(new Minefield());
        multigameWindow.setVisible(true); 
    }
    
    public void errorDialog() {
    	JOptionPane.showMessageDialog(null, "Input Only Valid value"
				, "ÀçÀÔ·Â", JOptionPane.INFORMATION_MESSAGE);
    }
