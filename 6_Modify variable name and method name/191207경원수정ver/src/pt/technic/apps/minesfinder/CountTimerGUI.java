...
public class CountTimerGUI implements ActionListener {
    ...
    public class CountTimer implements ActionListener {
        ...
        public CountTimer() {
        	...
        	int result_time = JOptionPane.showConfirmDialog(null, time, "Input Setting Time (Seconds) [Within 10 letters]" , JOptionPane.OK_CANCEL_OPTION);
        ...
        public void actionPerformed(ActionEvent e) {
        	...
        	if (isTimerActive) {
                ...
                setTimerText(TimeFormat(count));
                if(count == 0 ) {
                	int reply_timerover = JOptionPane.showConfirmDialog(null, " Are you playing continuously ", "Continuously?", JOptionPane.YES_NO_OPTION  );
